...
- **QQQ** ✅ PASS
  - Bars: 58,425 | Sessions: 753
  - Date range: 2023-05-24 → 2026-05-29
...
- Total trades: 30
- Total return: +7.4%
- Sharpe ratio: 8.080 (threshold: > -1.0)
- Max drawdown: 0.6%
- Win rate: 70.0%
- Consistency: 87.5% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 8.080 vs. baseline: 0.743 → delta: +7.337
- Return (optimized): +7.4% vs. baseline: +0.8%
- Win rate (optimized): 70.0% vs. baseline: 47.7%
