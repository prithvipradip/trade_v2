...
- Total trades: 63
- Total return: -2.9%
- Sharpe ratio: -0.711 (threshold: > -1.0)
- Max drawdown: 8.6%
- Win rate: 55.6%
- Consistency: 42.9% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): -0.711 vs. baseline: 3.991 → delta: -4.702
- Return (optimized): -2.9% vs. baseline: +8.2%
- Win rate (optimized): 55.6% vs. baseline: 56.7%
