...
- **QQQ** ✅ PASS
  - Bars: 58,680 | Sessions: 756
  - Date range: 2023-05-19 → 2026-05-29
...
- Total trades: 40
- Total return: -5.9%
- Sharpe ratio: -6.434 (threshold: > -1.0)
- Max drawdown: 5.9%
- Win rate: 47.5%
...
- Sharpe (optimized): -6.434 vs. baseline: 2.848 → delta: -9.282
- Return (optimized): -5.9% vs. baseline: +4.3%
- Win rate (optimized): 47.5% vs. baseline: 58.3%
