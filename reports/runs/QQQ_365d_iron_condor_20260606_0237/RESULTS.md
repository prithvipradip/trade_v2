...
- **QQQ** ✅ PASS
  - Bars: 58,368 | Sessions: 752
  - Date range: 2023-05-25 → 2026-05-29
...
- Total trades: 25
- Total return: +5.2%
- Sharpe ratio: 6.554 (threshold: > -1.0)
- Max drawdown: 0.9%
- Win rate: 56.0%
- Consistency: 62.5% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 6.554 vs. baseline: 1.876 → delta: +4.678
- Return (optimized): +5.2% vs. baseline: +2.0%
- Win rate (optimized): 56.0% vs. baseline: 48.7%
