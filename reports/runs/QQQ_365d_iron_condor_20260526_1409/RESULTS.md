...
- Total trades: 29
- Total return: +4.4%
- Sharpe ratio: 5.413 (threshold: > -1.0)
- Max drawdown: 1.4%
- Win rate: 62.1%
- Consistency: 66.7% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 5.413 vs. baseline: 3.053 → delta: +2.360
- Return (optimized): +4.4% vs. baseline: +3.9%
- Win rate (optimized): 62.1% vs. baseline: 44.7%
