...
- **QQQ** ✅ PASS
  - Bars: 58,461 | Sessions: 754
  - Date range: 2023-05-23 → 2026-05-29
...
- Total trades: 40
- Total return: +2.6%
- Sharpe ratio: 2.940 (threshold: > -1.0)
- Max drawdown: 1.6%
- Win rate: 55.0%
- Consistency: 63.6% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 2.940 vs. baseline: 1.612 → delta: +1.328
- Return (optimized): +2.6% vs. baseline: +2.3%
- Win rate (optimized): 55.0% vs. baseline: 47.1%
