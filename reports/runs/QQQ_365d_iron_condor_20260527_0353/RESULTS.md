...
- **QQQ** ✅ PASS
  - Bars: 37,727 | Sessions: 487
  - Date range: 2024-05-14 → 2026-05-08
...
- Total trades: 33
- Total return: +6.9%
- Sharpe ratio: 5.701 (threshold: > -1.0)
- Max drawdown: 2.0%
- Win rate: 57.6%
- Consistency: 75.0% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 5.701 vs. baseline: 3.053 → delta: +2.648
- Return (optimized): +6.9% vs. baseline: +3.9%
- Win rate (optimized): 57.6% vs. baseline: 44.7%
