...
- Total trades: 26
- Total return: -1.0%
- Sharpe ratio: -2.032 (threshold: > -1.0)
- Max drawdown: 1.8%
- Win rate: 61.5%
...
- Sharpe (optimized): -2.032 vs. baseline: 1.612 → delta: -3.645
- Return (optimized): -1.0% vs. baseline: +2.3%
- Win rate (optimized): 61.5% vs. baseline: 47.1%
