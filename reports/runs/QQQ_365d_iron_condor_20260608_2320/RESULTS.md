...
- Total trades: 8
- Total return: +1.3%
- Sharpe ratio: 6.199 (threshold: > -1.0)
- Max drawdown: 0.4%
- Win rate: 62.5%
...
- Sharpe (optimized): 6.199 vs. baseline: 3.228 → delta: +2.971
- Return (optimized): +1.3% vs. baseline: +1.5%
- Win rate (optimized): 62.5% vs. baseline: 50.0%
