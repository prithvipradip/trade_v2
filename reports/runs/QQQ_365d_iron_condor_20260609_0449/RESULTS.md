...
- Total trades: 13
- Total return: +2.8%
- Sharpe ratio: 6.968 (threshold: > -1.0)
- Max drawdown: 0.5%
- Win rate: 69.2%
...
- Sharpe (optimized): 6.968 vs. baseline: 3.228 → delta: +3.740
- Return (optimized): +2.8% vs. baseline: +1.5%
- Win rate (optimized): 69.2% vs. baseline: 50.0%
