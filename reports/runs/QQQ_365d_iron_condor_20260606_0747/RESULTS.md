...
- Total trades: 32
- Total return: +7.6%
- Sharpe ratio: 8.209 (threshold: > -1.0)
- Max drawdown: 0.5%
- Win rate: 71.9%
...
- Sharpe (optimized): 8.209 vs. baseline: 1.902 → delta: +6.307
- Return (optimized): +7.6% vs. baseline: +3.1%
- Win rate (optimized): 71.9% vs. baseline: 53.7%
