...
- Total trades: 27
- Total return: -0.5%
- Sharpe ratio: -0.648 (threshold: > -1.0)
- Max drawdown: 1.7%
- Win rate: 59.3%
...
- Sharpe (optimized): -0.648 vs. baseline: 1.300 → delta: -1.948
- Return (optimized): -0.5% vs. baseline: +1.8%
- Win rate (optimized): 59.3% vs. baseline: 46.0%
