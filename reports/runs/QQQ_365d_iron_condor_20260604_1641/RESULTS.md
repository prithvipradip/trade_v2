...
- Total trades: 28
- Total return: +1.7%
- Sharpe ratio: 3.139 (threshold: > -1.0)
- Max drawdown: 0.8%
- Win rate: 64.3%
- Consistency: 72.7% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 3.139 vs. baseline: 1.612 → delta: +1.527
- Return (optimized): +1.7% vs. baseline: +2.3%
- Win rate (optimized): 64.3% vs. baseline: 47.1%
