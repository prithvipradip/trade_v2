...
- Total trades: 13
- Total return: +8.1%
- Sharpe ratio: 25.353 (threshold: > -1.0)
- Max drawdown: 0.1%
- Win rate: 92.3%
...
- Sharpe (optimized): 25.353 vs. baseline: 6.121 → delta: +19.232
- Return (optimized): +8.1% vs. baseline: +14.4%
- Win rate (optimized): 92.3% vs. baseline: 73.5%
