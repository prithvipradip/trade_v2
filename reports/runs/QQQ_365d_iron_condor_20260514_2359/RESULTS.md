...
- Total trades: 29
- Total return: +21.4%
- Sharpe ratio: 10.862 (threshold: > -1.0)
- Max drawdown: 2.9%
- Win rate: 62.1%
- Consistency: 55.6% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 10.862 vs. baseline: 5.603 → delta: +5.259
- Return (optimized): +21.4% vs. baseline: +24.1%
- Win rate (optimized): 62.1% vs. baseline: 64.3%
