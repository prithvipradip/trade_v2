...
- **QQQ** ✅ PASS
  - Bars: 58,225 | Sessions: 751
  - Date range: 2023-05-26 → 2026-05-29
  - Coverage: 99.4% (threshold: ≥ 80%)
  - Sparse sessions (< 60 bars): 9
...
- Total trades: 15
- Total return: +3.8%
- Sharpe ratio: 10.502 (threshold: > -1.0)
- Max drawdown: 0.4%
- Win rate: 73.3%
- Consistency: 71.4% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 10.502 vs. baseline: 4.575 → delta: +5.926
- Return (optimized): +3.8% vs. baseline: +3.0%
- Win rate (optimized): 73.3% vs. baseline: 52.2%
