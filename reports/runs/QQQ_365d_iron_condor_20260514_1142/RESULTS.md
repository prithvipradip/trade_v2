...
- **QQQ** ✅ PASS
  - Bars: 38,349 | Sessions: 495
  - Date range: 2024-05-02 → 2026-05-08
  - Coverage: 99.3% (threshold: ≥ 80%)
...
**1-day horizon**: 0/5 features significant (p<0.05) | best IC: psd_beta = +0.0960
**3-day horizon**: 1/5 features significant (p<0.05) | best IC: psd_beta = +0.1093
**5-day horizon**: 1/5 features significant (p<0.05) | best IC: psd_beta = +0.1037
**10-day horizon**: 2/5 features significant (p<0.05) | best IC: multifractal_asymmetry = +0.1307
**20-day horizon**: 2/5 features significant (p<0.05) | best IC: multifractal_asymmetry = +0.3176
...
- Total trades: 91
- Total return: +183.1%
- Sharpe ratio: 23.952 (threshold: > -1.0)
- Max drawdown: 0.2%
- Win rate: 91.2%
- Consistency: 94.4% profitable windows

---

## E. Ablation (baseline: no optimization)

- Sharpe (optimized): 23.952 vs. baseline: 2.854 → delta: +21.098
- Return (optimized): +183.1% vs. baseline: +9.0%
- Win rate (optimized): 91.2% vs. baseline: 62.2%
