  ...
  for (const w of windows) {
    ...
    for (let i = w._startIdx; i <= w._endIdx - 4 && entered < 4; i++) {
      ...
      trades.push({
        ...
        limit_price: round(credit / 100, 2),
        fill_time: b.time + " 10:35:00",
        entry_idx: i, exit_idx: exitIdx,
        entry_price: round(credit / 100, 2), exit_price: round(credit / 100 * (0.3 + 0.5 * rnd()), 2),
        exit_underlying: round(bars[exitIdx].close, 2),
